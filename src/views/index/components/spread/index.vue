<template>
	<div class="spread">
        <div class="cnt">
            ...
            <div>
                <canvas ref="canvas" id="canvas" width="300" height="250" data-score='10000'></canvas>
            </div>
            ...
            <div class="ipt">
                <div class="row">
                    <input class="col" v-model="params.account"  maxlength="11" placeholder="请输入手机号"/>
                    <div class="line"></div>
                ...
                <div class="lb">点击"测试你能借多少"表示阅读并同意<a>《{{info.name}}}服务协议》</a></div>
            </div>
        </div>
