<template>
	<div class="sigin">
        <div class="sigin_logo">
            <img src="../../../../common/assets/images/logo.png" />
        </div>
		<div class="page-wrap">
            ...
            <div class="ipt">
                ...
                <div class="row"  v-if="currTab==1">
                    ...
                    <input type="tel" class="col" v-model="params.validCode" placeholder="请输入短信验证码" maxlength="6"/>
                    <span class="get">
                    ...
                    if(res.code === 200){
                        ...
                        setTimeout(res=>{   
                            if(this.productId){
                                ...
                                if (this.flag == 1) {
                                    this.$router.push({ path: "/my?flag=1" });
                                    try {
                                        window.android.getLoginMsg(token,tel);
                                    }
                                    catch(e) {
