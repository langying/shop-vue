...
<script>
	...
	export default {        
		...
		methods: {
            getHome(){
                // return this.info.website + "/#/loanSpread?flag=1";
                setTimeout(()=>{
                    location.href = (this.globalFun.browserCheck.versions.ios) ? this.info.ipaURL : this.info.apkURL;
                }, 500);
            },
            getCode(){
                ...
                getCode({
                    ...
                    if(code === 200){
                        ...
                        Toast({message: "您已注册，即将下载" + appName});
                        this.getHome();
                    }else{
                ...
                if(validCode.length == 4){
                    register({
                        ...
                        if(res.code === 200){
                            ...
                            Toast({message: "注册成功，即将下载" + appName});
                            this.getHome();
