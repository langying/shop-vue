	...
	<div class="spread">
        ...
        <div class="block">
            <div class="cnt">
                ...
                <div class="btn"><img src="../../../../common/assets/images/spread-btn.png" alt="" @click="submit"></div>
                <div class="xieyi">点击"马上领钱"视为同意<span @click="agreement">《用户注册协议》</span></div>
                <div class="record">
                    <p>{{info.title}}</p>
                    <p>{{info.copyright}}</p>
                </div>
            ...
            submit(){
                ...
                register({
                    ...
                    if(res.code === 200){
                        ...
                        setTimeout(()=>{
                            // this.$router.push({ path : "/spread/load" });
                            location.href = this.info.appURL;
                        }, 1000);
